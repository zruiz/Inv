...
<div class="page-header parallax banner" style="background-image:url(<?php echo esc_url($image); ?>); background-color:<?php echo esc_attr($color) ?>; height:<?php echo esc_attr($height).'px' ?>;">
    	<div class="container">
