            	...
            	<div class="row" id="listing-with-filter">
                    ...
                    <div class="col-md-3 search-filters" id="Search-Filters">
                    	<div class="filters-sidebar">
                            <h3><?php _e('Search By','framework'); ?></h3>
...
<a data-range="0-10000" class="range-val btn-primary btn-sm btn"><?php _e('Filter', 'framework'); ?></a></li>
                                            <?php } else { 
                                                ...
                                                <?php } else { ?>
                                                    <li class="list-group-item"><span class="badge"><?php echo esc_attr($total_cars); ?></span><?php echo $comparision; ?><a class="<?php echo $get_child_filter; ?>" href="#"><?php echo esc_attr($prefix.number_format($tab['imic_plugin_specification_values'])); ?></a></li>
                                           	<?php } } } ?>
                                            </ul>
                                        </div>
                                    </div>
