...
$permalinks = get_option('imic_property_permalinks');
?>
<input name="properties_contract_type_slug" type="text" class="regular-text code" value="<?php if ( isset( $permalinks['contract_types'] ) ) echo esc_attr( $permalinks['contract_types'] ); ?>" placeholder="<?php echo _x('cars_category', 'slug', 'imic-framework-admin') ?>" />
<?php
}
/**
    ...
    <table class="imic_form form-table">
        <tbody>
            <tr>
                ...
                <td><code><?php echo home_url(); ?>/?cars=sample-property-item</code></td>
            </tr>
            <tr>
