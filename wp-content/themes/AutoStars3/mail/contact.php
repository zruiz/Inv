...
if(trim($fname) == '') {
	echo '<div class="alert alert-error">'.esc_html__('You must enter your first name.', 'framework').'</div>';
	exit();
} else if(trim($email) == '') {
	echo '<div class="alert alert-error">'.esc_html__('You must enter email address.', 'framework').'</div>';
	exit();
} else if(!isEmail($email)) {
	echo '<div class="alert alert-error">'.esc_html__('You must enter a valid email address.', 'framework').'</div>';
	exit();
}
elseif($exact_val!=$captcha_answer)
	{
		echo '<div class="alert alert-error">'.esc_html__('Captcha do not match.','framework').'</div>';
		exit();
	}
