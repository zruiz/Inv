<?php
function ihc_print_subscription_layout($template, $levels, $register_url, $custom_css=''){
	$str = '';
			...
			foreach ($levels as $id => $level){
				...
				$str .= '<div class="ihc-level-item">'
					. '<div class="ihc-level-item-top">'
						. '<div class="ihc-level-item-title">'.$level['label'].'</div>'
					. '</div>'
					. '<div class="ihc-level-item-content">'.$level['description'].'</div>'
					. '<div class="ihc-level-item-bottom">'
						. '<div class="ihc-level-item-price">'.$level['price_text'].'</div>'
						.ihc_print_level_link( array('id'=>$id, 'register_page' => $register_url ) )
