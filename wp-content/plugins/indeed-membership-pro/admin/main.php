...
function ihc_admin_run_plugin_updates(){
	...
	if (!wp_get_schedule( 'ihc_check_level_downgrade')){
		wp_schedule_event(time(), 'hourly', 'ihc_check_level_downgrade');// twicedaily
	}
	...
	//==================== Register Fields
	if (get_option('ihc_update_version4')===FALSE){
...
<p>If you did not request for a new password, please ignore this Email notification.</p>';
		...
		update_option('ihc_update_version4', 1);//ihc_update_version
	}
}
