...
<div class="iump-wrapper">
	<div id="col-right" style="vertical-align:top; width: 100%;">
		...
		if(isset($_REQUEST['search_user']) || isset($_REQUEST['filter_role']) || isset($_REQUEST['orderby_user']) || isset($_REQUEST['ordertype_user']) ) $hidded ='';
		?>		
		...
		<form method="post" action="" style="margin-top:20px;">
			...
			<div>
				<?php 					
					...
					$no_users = count($all_users->results);
					$pagination = '';
					if($no_users>$limit){
						...
						for($i=1;$i<=$no_pag;$i++){
							...
							$pagination .= '<a href="'.$admin_url.'?page=ihc_manage&tab=users&ihc_limit='.$limit.'&ihcdu_page='.$i.'" class="ihc-user-pagination '.$selected.' '.$visible.'">'.$i.'</a>';
						}
