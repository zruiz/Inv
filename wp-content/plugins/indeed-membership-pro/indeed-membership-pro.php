...
function ihc_initiate_plugin() {
	...
	$values = array( 'payment', 'login', 'login-messages', 'general-defaults', 'general-msg', 'general-captcha',
					 'general-subscription', 'register', 'register-msg', 'register-custom-fields' );
